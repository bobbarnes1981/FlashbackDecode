...
namespace Decoder
{
    ...
    class RomHeader
    {
        ...
        public RomHeader(Data data)
        {
            this.data = data;
        }

        private string readString(uint address, int length)
        {
            byte[] s = new byte[length];
            for (int i = 0; i < length; i++)
            {
                s[i] = this.data.ReadByte((uint)(address + i));
            }
        ...
        public string ConsoleName
        {
            get
            {
                return this.readString(0x0100, 16);
            }
        }
        ...
        public string Copyright
        {
            get
            {
                return this.readString(0x0110, 16);
            }
        }
        ...
        public string DomesticName
        {
            get
            {
                return this.readString(0x0120, 48);
            }
        }
        ...
        public string InternationalName
        {
            get
            {
                return this.readString(0x0150, 48);
            }
        }
        ...
        public string Version
        {
            get
            {
                return this.readString(0x0180, 14);
            }
        }
        ...
        public ushort Checksum
        {
            get
            {
                return this.data.ReadWord(0x018E);
            }
        }
